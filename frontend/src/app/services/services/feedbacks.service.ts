...
export class FeedbacksService extends BaseService {
  ...
  static readonly SaveFeedbackPath = '/feeback';
  ...
  static readonly FindAllFeedbacksByBookPath = '/feeback/book/{book-id}';
   ...
   */
  findAllFeedbacksByBook$Response(params: FindAllFeedbacksByBook$Params, context?: HttpContext): Observable<StrictHttpResponse<PageFeedbackResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  findAllFeedbacksByBook(params: FindAllFeedbacksByBook$Params, context?: HttpContext): Observable<PageFeedbackResponse> {
    return this.findAllFeedbacksByBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<PageFeedbackResponse>): PageFeedbackResponse => r.body)
    );
  }
